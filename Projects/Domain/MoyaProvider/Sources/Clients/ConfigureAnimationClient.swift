...
public struct ConfigureAnimationClient {
  public var add: @Sendable (ConfigureAnimationRequest) async throws -> EmptyResponse
  public var downloadVideo: @Sendable (ConfigureAnimationRequest) async throws -> Data
}

...
public struct MakeADClient {
  public var step1UploadDrawing: @Sendable (UploadADrawingRequest) async throws -> UploadADrawingResposne
  
  public var step2FindTheCharacter: @Sendable (FindTheCharacterRequest) async throws -> EmptyResponse
  public var step2DownloadMaskImage: @Sendable (String) async throws -> UIImage
  
  public var step3SeparateCharacter: @Sendable (SeparateCharacterRequest) async throws -> SeparateCharacterReponse
  
  public var step4findCharacterJoints: @Sendable (FindCharacterJointsRequest) async throws -> EmptyResponse
}

...
//struct Preview_MaskableUIViewRepresentable: View {
//  var body: some View {
//    _MaskableUIViewRepresentable(
//      myFrame: <#T##CGRect#>,
//      croppedImage: <#T##UIImage#>,
//      initMaskImage: <#T##UIImage#>,
//      curDrawAction: <#T##DrawingAction#>,
//      curCirleRadius: <#T##CGFloat#>
//    )
//  }
//}

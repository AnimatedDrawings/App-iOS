...
struct TestCropImageView: View {
  var originalImage: UIImage
  @Binding var croppedImage: UIImage?
  
  @State var originalImageWidthOnScreen: CGFloat = 0
  
  init(
    originalImage: UIImage = UIImage(asset: ADUtilsAsset.SampleDrawing.garlic)!,
  ...
  var body: some View {
    VStack(spacing: 30) {
      HStack(spacing: 20) {
        Image(uiImage: originalImage)
          ...
          .overlay {
            GeometryReader {
              ...
              Color.clear
                .onAppear {
                  self.originalImageWidthOnScreen = size.width
                }
            }
          }
        ...
        .frame(width: self.originalImageWidthOnScreen)
      }
      .frame(height: 200)
...
//public struct TestCropImageView: View {
//  @State var croppedImage: UIImage? = nil
//
//  public var body: some View {
//    CropImageView(croppedImage: $croppedImage)
//  }
//}
...
//    cropperShown: Bool = false
//  ) {
//    self.originalImage = originalImage
//    self.croppedImage = croppedImage
//    self.cropperShown = cropperShown
//  }
//
//  var body: some View {
//    VStack {
...
//      Spacer()
//
//      ImageCroppingView(image: originalImage!, croppedImage: $croppedImage)
//    }
//  }
//}
